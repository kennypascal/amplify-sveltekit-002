...
# Welcome to Storefront App Components

The Storefront app uses Storybook to help you build UI components in isolation from your app's business logic, data, and context.
